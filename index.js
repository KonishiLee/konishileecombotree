...
(function ( $, window, document, undefined ) {
    ...
    ComboTree.prototype.init = function () {
        ...
        this._elemArrowBtn = $('<em id="' + this.comboTreeId + 'ArrowBtn" class="fa fa-caret-down comboTreeArrowBtn" aria-hidden="true"></em>')
                        .css({
        ...
        this._elemWrapper.append('<div id="' + this.comboTreeId + 'DropDownContainer" class="comboTreeDropDownContainer selectize-dropdown"><div class="comboTreeDropDownContent"></div>');
    ...
    ComboTree.prototype.createSourceSubItemsHTML = function (subItems) {
        var subItemsHtml = '<ul class="selectize-dropdown-content">';
    ...
    ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
        var itemHtml = "",
            isThereSubs = sourceItem.hasOwnProperty("childCagegory");

        itemHtml = '<li class="combo-tree-item ComboTreeItem' + (isThereSubs?'Parent':'Chlid') + '"> ';

        if (isThereSubs)
            itemHtml += '<span class="comboTreeParentPlus">&minus;</span>';

        if (this.options.isMultiple)
            itemHtml += '<span data-id="' + sourceItem.id + '" class="comboTreeItemTitle"><input type="checkbox">' + sourceItem.name + '</span>';
        else
            itemHtml += '<span data-id="' + sourceItem.id + '" class="comboTreeItemTitle">' + sourceItem.name + '</span>';

        if (isThereSubs)
            itemHtml += this.createSourceSubItemsHTML(sourceItem.childCagegory);
    ...
    ComboTree.prototype.refreshInputVal = function () {
        ...
        $(this).trigger('choice', this._selectedItem);
